(function ($) {
  ...
  $('#experience-timeline').each(function () {
    ...
    $userContent.each(function () {
      const iconName = $(this).data('style');

      $(this)
        .addClass('vtimeline-content')
        .wrap('<div data-icon="' + iconName + '" class="vtimeline-point"><div class="vtimeline-block"></div></div>');
    });
    ...
    $this.find('.vtimeline-point').each(function () {
      ...
      $(this).prepend('<div class="vtimeline-icon ' + iconName + '-icon"></div>');
    });
